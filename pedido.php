                            ...
                            <?php
                                if(!$_SESSION['nombreUser']=="" &&!$_SESSION['claveUser']==""){
                                    echo '
                                        ...
                                        <p class="text-center">Para confirmar su pedido haga clic en el botón confirmar</p>
                                        <br>
                                    ...
                                    echo '
                                        ...
                                        <p>
                                            Para confirmar su compra debe iniciar sesión o introducir su nombre de usuario
                                            y contraseña con la cual haya sido registrado previamente en el <span class="tittles-pages-logo">Centro de Acopio "El Gachupín"</span>.
                                        </p>
                                        <br>
